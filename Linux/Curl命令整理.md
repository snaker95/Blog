...
# curl -O url
curl -O http://www.sina.com.cn/home.html
# curl
...
```shell
# 正则表达式
curl -O http://mydomain/screen[1-10].png
```
...
```shell
# 正则表达式
curl -O http://mydomain/{zzh,nick}/screen[1-10].png
```
...
```shell
# 正则表达式
curl -o #2_#1.png http://mydomain/{zzh,nick}/screen[1-10].png
```
...
curl -r 10241 -20480  -o "zhao.part2"  http://mydomain.net/~zzh/zhao1.mp3 &\
curl -r 20481 -40960  -o "zhao.part3"  http://mydomain.net/~zzh/zhao1.mp3 &\
curl -r 40961 - -o  "zhao.part4"  http://mydomain.net/~zzh/zhao1.mp3
...
...
```shell
curl -D cookie0001.txt http://mydomain.net
```

#### 使用cookies

```shell
curl -b cookie0001.txt http://mydomain.net
```

#### 使用UserAgent

```shell
curl -A "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0)" http://mydomain.net
```

#### 伪造referer

```shell
curl -e"mail.yahoo.com" http://mydomain.net
```

#### 指定Header头

```shell
curl -H 'Host: gateway-dev.guazi-cloud.com' http://mydomain.net
```
